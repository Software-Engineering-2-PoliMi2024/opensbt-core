...
# The initial angle is set to 270 degrees
# The segment length è nel config
# variable names are useless
# Max time and max xte in config

print(UdacitySimulator.simulate([
    [0, 0],
    ], [
    "angle1",
    "angle2",
